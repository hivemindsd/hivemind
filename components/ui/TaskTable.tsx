...
function DialogScrollableContent({ task_name, description, due_date, priority, status, isOpen, onOpenChange}: Task & {isOpen : boolean, onOpenChange : (open: boolean) => void}) {
  return (
...
export function TaskTable({
	...
	return (
	<>
	{selectedTask && (<DialogScrollableContent
						{...selectedTask}
						isOpen={!!selectedTask}
